...
class InformationRecord extends StatefulWidget {
  ...
  InformationRecord({required this.formValidInfo});
...
class _InformationRecordState extends State<InformationRecord> {
  ...
  FormValidInfo? formValidInfo = FormValidInfo.doctorInfo;

  @override
  Widget build(BuildContext context) {
    return widget.formValidInfo == FormValidInfo.doctorInfo ? buildDoctorInfo():buildPatientInfo();
  }
